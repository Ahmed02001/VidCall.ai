 ...
 * HomePage.jsx
 *
 * This component renders the landing page for the VidCall.ai application.
 * It includes the following major sections:
 * - responsive navbar with logo and sign-in call-to-action
 * - hero section with headline, feature highlights, and primary actions
 * - supporting feature cards showing core platform capabilities
 *
 * The page uses utility classes for styling and integrates Clerk's
 * SignInButton for modal-based authentication.
 */
 ...
 * HomePage
 *
 * @returns {JSX.Element} The landing page for VidCall.ai.
 */
